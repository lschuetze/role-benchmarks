...
/bin/bash $SCRIPT_PATH/java14.sh $JVM_ARGS -jar ${SCRIPT_PATH}/../benchmarks/jmh-otj/target/jmh-otj-artefacts-graceful-infra.jar -prof perfasm ManyAfterCallinsBenchmark -p cnt=100
