...
/bin/bash $SCRIPT_PATH/java14.sh $JVM_ARGS -jar ${SCRIPT_PATH}/../benchmarks/jmh-otj/target/jmh-otj-artefacts-graceful-infra.jar ManyCallinsBenchmark "$@"
...
/bin/bash $SCRIPT_PATH/java14.sh $JVM_ARGS -jar ${SCRIPT_PATH}/../benchmarks/jmh-otj/target/jmh-otj-artefacts-classic-infra.jar ManyCallinsBenchmark "$@"
